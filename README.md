## 주제: SSR, CSR을 이용하여 인스타그램의 주요 기능을 Next.js를 활용하여 구현 
(1인 사이드 프로젝트)
...
- 자신이 작성하거나 팔로잉한 유저들이 작성한 **포스트**를 보여줍니다. <br/>
(demo 에서는 현재 팔로잉 유저가 없으므로 모든 포스트를 볼 수 있게 구현했습니다.)
